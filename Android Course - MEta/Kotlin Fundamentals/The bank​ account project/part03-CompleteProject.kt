fun main() {
    ...
    //Starting part 03 - Completing the Project 
    
    
   /*Implement the transfer operation for checking, debit and credit accounts
	Implementing a function to handle the transfer logic of withdrawals and deposits for checking, debit and credit accounts.
    */
    ...
    /*
     Create variables for the virtual bank system interface status and user interface option
	 This step created variables that store the bank system interface’s status and the option 
     that the user selects from the console. 
     */ 
    ...
    /*
      ...
      Next,manage the bank account and the specific operations based on the user’s input.
     */ 
